#ifndef MICRO_LIBMATH_MATRIX4X2_HH__GUARD
#define MICRO_LIBMATH_MATRIX4X2_HH__GUARD
...
namespace micro::math
{
	...
	struct TMatrix4x2
	{
		...
		constexpr TMatrix4x2(T _11 = {}, T _12 = {},
				     T _21 = {}, T _22 = {},
				     T _31 = {}, T _32 = {},
				     T _41 = {}, T _42 = {}) noexcept
		{
			data[0] = {_11, _12};
			data[1] = {_21, _22};
			data[2] = {_31, _32};
		...
		constexpr TMatrix4x2(TVector2<T> const &_1,
				     TVector2<T> const &_2,
				     TVector2<T> const &_3,
				     TVector2<T> const &_4) noexcept
		{
			data[0] = _1;
			data[1] = _2;
			data[2] = _3;
	...
	template <class T>
	inline TVector4<T> operator*(TMatrix4x2<T> const &l, TVector2<T> const &r) noexcept
	{
	...
	{
		return TMatrix4x2<T>{l.data[0] + r.data[0],
				     l.data[1] + r.data[1],
				     l.data[2] + r.data[2],
				     l.data[3] + r.data[3]};
	}
	...
	template <class T>
	constexpr TMatrix4x2<T> operator*(T s, TMatrix4x2<T> const &m) noexcept
	{
		return TMatrix4x2<T>{s * m.data[0],
				     s * m.data[1],
				     s * m.data[2],
				     s * m.data[3]};
	}
	...
	template <class T>
	constexpr TMatrix4x2<T> operator*(TMatrix4x2<T> const &m, T s) noexcept
	{
		return TMatrix4x2<T>{m.data[0] * s,
				     m.data[1] * s,
				     m.data[2] * s,
				     m.data[3] * s};
	}
	...
	template <class T>
	constexpr TMatrix4x2<T> operator+(TMatrix4x2<T> const &a) noexcept
	{
		return a;
	}
	...
	constexpr TMatrix4x2<T> operator-(TMatrix4x2<T> const &a) noexcept
	{
		return TMatrix4x2<T>{} - a;
	}

	// --------------------------- Relational -------------------------- //

	template <class T>
	constexpr TMatrix4x2<bool> operator<(TMatrix4x2<T> const &a,
					     TMatrix4x2<T> const &b) noexcept
	{
		return TMatrix4x2<bool>{a.data[0] < b.data[0],
					a.data[1] < b.data[1],
					a.data[2] < b.data[2],
					a.data[3] < b.data[3]};
	}
	...
	constexpr TMatrix4x2<bool> operator&&(TMatrix4x2<bool> const &a,
					      TMatrix4x2<bool> const &b) noexcept
	{
		return TMatrix4x2<bool>{a.data[0] && b.data[0],
					a.data[1] && b.data[1],
					a.data[2] && b.data[2],
	...
	constexpr bool all(TMatrix4x2<bool> const &a) noexcept
	{
		return all(a.data[0]) &&
		       all(a.data[1]) &&
		       all(a.data[2]) &&
	...
	constexpr bool any(TMatrix4x2<bool> const &a) noexcept
	{
		return any(a.data[0]) ||
		       any(a.data[1]) ||
		       any(a.data[2]) ||
